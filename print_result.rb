...
class PrintResult
  def initialize
  @answers = [#30 - 32 очков
  "Вы явно некоммуникабельны, и это Ваша беда, " +
  "так как больше всего страдаете от этого Вы сами. "+
  ...
  "Вспыльчивы, обидчивы, нередко бываете необъективны."+
  "Серьезная работа не для Вас. Людям – и на работе, и дома, и вообще повсюду – трудно с Вами."+
